    ...
    def train_fn(self, epoch):
        ...
        for data in self.train_loader:
            ...
            if self.args.floor_loss:
                ...
                print('Training. Epoch: {}/{}, Datapoint: {}/{}, Bits/dim: {:.3f}'.format(epoch + 1, self.args.epochs,
                                                                                          loss_count,
                                                                                          len(self.train_loader.dataset),
                                                                                          loss_sum / loss_count),
                      end='\r')
        ...
        return {'bpd': loss_sum / loss_count, 'floor_loss': loss_floor_sum / loss_count} if self.args.floor_loss else {'bpd': loss_sum / loss_count}
        ...
        with torch.no_grad():
            ...
            for data in self.train_loader:
                ...
                if self.args.floor_loss:
                    ...
                    print('     Evaluating. Epoch: {}/{}, Datapoint: {}/{}, Bits/dim: {:.3f}'.format(epoch + 1,
                                                                                                     self.args.epochs,
                                                                                                     loss_count,
                                                                                                     len(self.eval_loader.dataset),
                                                                                                     loss_sum / loss_count),
